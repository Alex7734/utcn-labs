...
static const yytype_int8 yyrhs[] =
{
      ...
      -1,     3,     9,    15,    10,    -1,    14,    10,    -1,    14,
       5,    14,    -1,    14,     6,    14,    -1,    14,     7,    14,
      -1,     3,    -1,    15,     8,    16,    -1,    16,    -1,    16,
       4,    -1,     4,    -1
};
...
{
       4,     0,     1,    10,     3,     0,     0,     0,     2,     0,
       0,     0,     6,    14,     0,    12,    10,     7,     8,     9,
       0,     5,    13,    11
};
...
{
      -9,     0,    -9,    -8,    -9,    -6,    -1,     3,    -9,    11,
      11,    11,    -9,    -9,     5,    12,    -9,    10,    10,    -9,
       3,    -9,    -9,    12
};
...
{
       2,     7,     8,     3,     9,    10,    11,    13,     4,    12,
      17,    18,    19,    20,    16,    21,    22,    11,    23
};

static const yytype_uint8 yycheck[] =
{
       0,     9,     8,     3,     5,     6,     7,     4,     8,    10,
       9,    10,    11,     8,     3,    10,     4,     7,    20
};
...
{
       0,    12,     0,     3,     8,    13,    14,     9,     8,     5,
       6,     7,    10,     4,    15,    16,     3,    14,    14,    14,
       8,    10,     4,    16
};
  ...
  switch (yyn)
    {
        case 2:
#line 50 "matrix.y"
    {print_matrix((yyvsp[(2) - (3)].matrix));}
    break;

  case 5:
#line 55 "matrix.y"
    { mem[(yyvsp[(1) - (4)].ival)] = (yyvsp[(3) - (4)].matrix); (yyval.matrix) = (yyvsp[(3) - (4)].matrix); }
    break;

  case 6:
#line 56 "matrix.y"
    { (yyval.matrix) = (yyvsp[(1) - (2)].matrix); }
    break;

  case 7:
#line 59 "matrix.y"
    { (yyval.matrix) = sum_matrices((yyvsp[(1) - (3)].matrix), (yyvsp[(3) - (3)].matrix)); }
    break;

  case 8:
#line 60 "matrix.y"
    { (yyval.matrix) = sub_matrices((yyvsp[(1) - (3)].matrix), (yyvsp[(3) - (3)].matrix)); }
    break;

  case 9:
#line 61 "matrix.y"
    { (yyval.matrix) = mul_matrices((yyvsp[(1) - (3)].matrix), (yyvsp[(3) - (3)].matrix)); }
    break;

  case 10:
#line 62 "matrix.y"
    { (yyval.matrix) = mem[(yyvsp[(1) - (1)].ival)]; }
    break;

  case 11:
#line 65 "matrix.y"
    { add_row((yyvsp[(1) - (3)].matrix), (yyvsp[(3) - (3)].row)); }
    break;

  case 12:
#line 66 "matrix.y"
    { (yyval.matrix) = create_matrix((yyvsp[(1) - (1)].row)); }
    break;

  case 13:
#line 69 "matrix.y"
    { add_number_to_row((yyvsp[(1) - (2)].row), (yyvsp[(2) - (2)].ival)); }
    break;

  case 14:
#line 70 "matrix.y"
    { (yyval.row) = create_row((yyvsp[(1) - (1)].ival)); }
    break;
...
int check_dimensions(matr *m1, matr *m2) {
    return m1->no_rows_used == m2->no_rows_used && m1->rows[0]->no_columms_used == m2->rows[0]->no_columms_used;
}
